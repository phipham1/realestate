...
// Line 6 und Line 46 auskommenbtiert import io.oasp.gastronomy.restaurant.salesmanagement.common.api.exception.ChangeTableIllegalStateCombinationException;
...
public class UcChangeTableImpl extends AbstractUc implements UcChangeTable {
  ...
  public void changeTable(long orderId, long newTableId) {
    ...
    if (newTable.getState().isOccupied()) {
      //hier throw new ChangeTableIllegalStateCombinationException(order, newTable);
    }
